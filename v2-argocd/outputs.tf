...
output "tenant_id" {
  description = "Azure AD tenant ID -- plug this into chart/values.yaml as keyVault.tenantId. Not hardcoded in the chart so it isn't tied to one specific tenant."
